    ...
    return (
      <div style={{
        ...
        <div style={{ textAlign: "center" }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.75)", fontSize: "13px", margin: "0 0 20px" }}>
        ...
        {error && (
          <div style={{
            ...
            <button onClick={() => setError("")} style={{
              ...
              fontSize: "18px", cursor: "pointer", color: "#991b1b"
            }}>×</button>
          </div>
        )}
        ...
        <div style={{
          ...
          <div style={{ display: "flex", gap: "10px", marginBottom: "12px", flexWrap: "wrap" }}>
            ...
            <button onClick={addTodo} disabled={isAdding} style={{
              ...
              opacity: isAdding ? 0.7 : 1, fontFamily: "inherit"
            }}>
              {isAdding ? "Adding..." : "+ Add"}
            </button>
          </div>
            ...
            <div style={{ position: "relative" }}>
              ...
              <input
                ...
                style={{
                  ...
                  outline: "none", color: "#1f2937", width: "140px",
                  fontFamily: "inherit"
                }}
                onFocus={e => e.target.style.borderColor = "#667eea"}
                onBlur={e => e.target.style.borderColor = "#e5e7eb"}
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
            ...
            {filtered.length === 0 ? (
              <div style={{
                ...
                <h3 style={{ margin: "0 0 6px", color: "#374151", fontSize: "16px", fontWeight: "600" }}>
                  No tasks found
                </h3>
